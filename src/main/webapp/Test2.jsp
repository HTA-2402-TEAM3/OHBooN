    ...
    <aside>
        <ul>
            <c:forEach items="${requestScope.chatList}" var="ChatDTO" varStatus="loop">
                ...
                <!-- 프로필 이미지 URL 가져오기 -->
                <c:set var="profileImage" value="${userDTO.getProfileImage()}" />
                    ...
                    <a href="/enterChat?chat_id=${ChatDTO.chatID}">
                        <c:choose>
                            ...
                            <c:when test="${not empty profileImage}">
                                <img src="${profileImage}" alt="${subject}님의 프로필 이미지">
                            </c:when>
                            <!-- 프로필 이미지가 없는 경우 기본 이미지 사용 -->
                            <c:otherwise>
                                <img src="image/default.png" alt="기본 프로필 이미지">
                            </c:otherwise>
            ...
            <li>
<%--                기본이미지 --%>
                <a href="/enterChat?chat_id=1">
                    <img src="image/default.png" alt="">

                    <div>
                        <h2>ehrud 님의 프로필</h2>
                        <h3>ehrud 님 과의 대화</h3>
                        <p>ehrud님 과의 마지막 대화 내용</p>
                    </div>
                </a>
            </li>
